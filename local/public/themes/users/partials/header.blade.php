          ...
          <div class="m-stack m-stack--ver m-stack--general">
            <div class="m-stack__item m-stack__item--middle m-brand__logo">
              <a href="../index.html" class="m-brand__logo-wrapper">
                <img alt="logo" src="https://franchise.tulitab.com/themes/web_img/logo.png"/>
              </a>
            </div>
...
m-dropdown-toggle="click" id="m_quicksearch" m-quicksearch-mode="dropdown" m-dropdown-persistent="1">
                ...
                <li class="m-nav__item m-topbar__quick-actions m-topbar__quick-actions--img ">
                  <a href="/{{ Auth::user()->slug}}" class="m-nav__link m-dropdown__toggle">
                ...
                <li class="m-nav__item m-tobar__quick-actions m-topbar__quick-actions--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-right m-dropdown--align-push m-dropdown--mobile-full-width m-dropdown--skin-light">
                  <a href="/" class="m-nav__link m-dropdown__toggle">
                    <span class="m-nav__link-badge m-badge m-badge--dot m-badge--info m--hide"></span>
                    <span class="m-nav__link-icon">
